...
// ESPP_CLASS
#ifndef _INTEGRATOR_LANGEVINTHERMOSTATNOCM_HPP
#define _INTEGRATOR_LANGEVINTHERMOSTATNOCM_HPP
...
namespace espressopp {
  namespace integrator {
    ...
    class LangevinThermostatNoCm : public Extension {

      public:

        LangevinThermostatNoCm(shared_ptr<System> system, int number_of_chains);
        virtual ~LangevinThermostatNoCm();
      ...
      private:
        ...
        Real3D frictionThermo(class Particle&);
        ...
        Real3D* excess_forces;
        Real3D* total_excess_forces;
        int totNPart;
